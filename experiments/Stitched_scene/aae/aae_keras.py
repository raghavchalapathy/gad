...
basepath = "/Users/raghav/Documents/Uni/group_anomalies_detection/groupAnomalies/experiments/Stitched_scene/aae/examples/aae/"
class AdversarialAutoencoder():
    ...
    def train(self, epochs, batch_size=128, save_interval=50):
        ...
        normal_dataPath = "/Users/raghav/Documents/Uni/group_anomalies_detection/groupAnomalies/data/kdd_2018/StitchedData/city_normal/"
        anomalies_dataPath = "/Users/raghav/Documents/Uni/group_anomalies_detection/groupAnomalies/data/kdd_2018/StitchedData/city_anomalies/"

        zeroshotDataPath = "/Users/raghav/Documents/Uni/group_anomalies_detection/groupAnomalies/data/kdd_2018/zeroshotData/"
        def readjpegimages2Array(filepath):
            ...
            ims = [np.array(Image.open(os.path.join(folder, filename)).convert('RGB')) for filename in
                   os.listdir(folder)]
            imageList = []
        ...
        [X_test, Y_test] = prepare_scene_data_with_anomalies(normal_dataPath, zeroshotDataPath)
        ...
        for epoch in range(epochs):
            ...
            idx_test = np.random.randint(0, X_test.shape[0], half_batch)
...
if __name__ == '__main__':
    ...
    aae.train(epochs=10, batch_size=32, save_interval=200)
    print('='*35)
    print (aae.decoded_imgs.shape)
    decoded = aae.decoded_imgs

    # ZeroShot Learning Data
    x_test= aae.test_imgs
    y_test= aae.y_test
