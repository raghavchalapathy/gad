    ...
    def save_images(self, sess, epoch):
        ...
        with open(os.path.join(
            ...
            for i in range(0, self._num_imgs_to_save):
                ...
                # Compute the Reconstruction errors and rank them accordingly
                # error_A = np.linalg.norm(inputs['images_i'] - cyc_A_temp)
                # error_B = np.linalg.norm(inputs['images_j'] - cyc_B_temp)
                # print "Meta: Information ================"
                # print type(inputs['images_i']),inputs['images_i'].shape
                # print type(cyc_A_temp),cyc_A_temp.shape
                # print "End - Meta: Information ================"
