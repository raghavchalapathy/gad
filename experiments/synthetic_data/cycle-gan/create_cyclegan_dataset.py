...
#
# def create_unique_mapping_dataset(image_path_a, image_path_b,
#                    dataset_name, do_shuffle):
#     print dataset_name
#     list_a = create_list(image_path_a, True,
#                          cyclegan_datasets.DATASET_TO_IMAGETYPE[dataset_name])
...
basepath = "/Users/raghav/Documents/Uni/group_anomalies_detection/groupAnomalies/data/cats_Vs_Dogs/test/"
a = basepath+"folder_a"
b= basepath+"folder_b"
dataset_name = "cats_n_dogs"
do_shuffle = 0
if __name__ == '__main__':
    create_dataset()
    # create_unique_mapping_dataset(a,b,dataset_name,do_shuffle)
